...
import profileImage from "assets/img/vector/profile.png";

import sectionBlogInfoStyle from "assets/jss/material-kit-pro-react/pages/blogPostSections/sectionBlogInfoStyle.jsx";
          ...
          <Card plain profile className={classes.card}>
            <GridContainer>
              ...
              <GridItem xs={12} sm={8} md={8}>
                <h4 className={classes.cardTitle}>Jorge Herrera</h4>
                <p className={classes.description}>
                D'ad nunc luctus ut molunt est est rem pactum vel aut sagina
                  armorum si cum Dignus Vitae oppresso...V lius quam class duis
                  Occidas.
                </p>
              </GridItem>
              <GridItem xs={12} sm={2} md={2}>
